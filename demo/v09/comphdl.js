...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "comphdl.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "comphdl.wasm", {credentials: "same-origin"} );
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_c0227b572ac343d9b559b2332cd878b34624f423": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){term.write (($1));})());
            },
            ...
            "__extjs_f6debf5633221ccb853f92e7e0bc824ff7af0188": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return editor.getValue ();})());
            },
            ...
            "__extjs_e6a545bbda37ca5982f9a0eed1bfbc47a8675334": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var t = document.getElementById (($1)); if (t != null){t.value = "" ;}})());
            },
            ...
            "__extjs_8da298e1fae40ade8f1a2ccd151f6fb61c490e9c": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){term2.writeln (($1));})());
            },
            ...
            "__extjs_8648b0c5d4260acfba8347163936cae2a1e2eb2e": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var txt = document.getElementById ("InputJSON_0"); txt.value = ($1);})());
            },
            ...
            "__extjs_520e38e36140141f09c44cc538584698a7af3091": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){var t = document.getElementById (($1)); if (t != null){t.value += ($2); t.scrollTop = t.scrollHeight ;}})());
            },
